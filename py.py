...
bot = telebot.TeleBot('7666417994:AAHGqVaUR7T13aLOzC79FkELpefvnuXlFOY')

# Admin user IDs (replace with your own admin IDs as strings)
admin_ids = ["6434780221","1490444757"]
...
@bot.message_handler(func=lambda message: message.text == '🚀 𝐀𝐭𝐭𝐚𝐜?? 🚀')
